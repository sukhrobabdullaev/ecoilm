    ...
    <div className="container">
      <div className="grid p-10 lg:gap-20 sm:grid-cols-8 lg:grid-cols-12 md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-8 lg:ms-40 lg:w-[500px] sm:col-span-6 rounded-lg py-3 bg-slate-200">
          ...
          <p className="text-blue-950 ms-6 text-lg mb-4">
          ...
          <div className="grid md:grid-cols-1 sm:grid-cols-1 grid-cols-2">
            <div className="">
              <div className="col-span-1">
                <input
                  className="w-80  md:w-[300px] sm:w-[400px] lg:w-[400px] lg:mt-5 lg:ms-10 md:ms-20 px-3 py-3 ms-6 "
                  type="text"
              ...
              <div className="col-span-1">
                <input
                  className="w-80 mt-2 md:w-[300px] sm:w-[400px] lg:w-[400px] lg:mt-5 lg:ms-10 md:ms-20 px-3 py-3 ms-6 "
                  type="text"
            ...
            <div className="col-span-1">
              <input
                className="w-80 md:w-[300px] sm:ms-6 sm:mt-4 lg:w-[400px] lg:mt-5 lg:ms-10 sm:w-[400px] md:ms-20 md:mt-4 px-3 py-3 ms-4 "
                type="email"
          ...
          <input
            className="w-[695px] md:w-[300px] sm:w-[400px] lg:w-[400px] lg:mt-5 lg:ms-10 md:ms-20 md:mt-4 py-3 px-3 ms-6 mt-[30px]"
            type="text"
          ...
          ></textarea>
          <button className="bg-blue-500 lg:ms-[357px] py-1 px-3 sm:ms-[336px] text-white rounded-lg mt-3 md:ms-[310px] ms-[635px]">
            Jo'natish
          </button>
        </div>
      </div>
